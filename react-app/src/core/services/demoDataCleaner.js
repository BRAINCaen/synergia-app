...
🎯 ÉTAPES RECOMMANDÉES :
1. Générer un rapport pour voir ce qui sera supprimé
2. Faire une sauvegarde si nécessaire
3. Exécuter le nettoyage complet
4. Vérifier que seules les vraies données restent

⚠️ ATTENTION :
- Cette opération est IRRÉVERSIBLE
- Tous les badges d'onboarding seront supprimés
- Les tâches avec plus de 10 assignations seront supprimées
- Les statistiques gonflées seront réinitialisées
*/
