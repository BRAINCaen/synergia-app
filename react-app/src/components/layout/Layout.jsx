...
const Layout = ({ children }) => {
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex">
      ...
      {/* SIDEBAR DESKTOP - Style original préservé */}
      ...
      <div className="flex-1 flex flex-col min-w-0 lg:ml-64 relative">
        ...
        {/* ✅ OVERLAY MOBILE - Ferme SEULEMENT quand on clique dessus */}
        <div 
          ...
          onClick={() => setSidebarOpen(false)} // ✅ Fermeture explicite
        />

        {/* ✅ SIDEBAR MOBILE - Maintenant STABLE */}
        <div 
                  ...
                  {section.items.map((item, itemIndex) => {
                    ...
                    return (
                      <Link
                        key={itemIndex}
                        to={item.path}
                        onClick={handleNavClick} // ✅ Fermeture SEULEMENT sur clic lien
                        className={`
                          group flex items-center px-3 py-2 text-sm font-medium rounded-md transition-colors
                          ${active
                            ? isAdminItem ? 'bg-red-900 text-red-100' : 'bg-blue-900 text-blue-100'
        ...
        <div className="lg:hidden flex items-center justify-between p-4 bg-white border-b border-gray-200 sticky top-0 z-30">
          <button
            onClick={() => setSidebarOpen(true)} // ✅ Ouverture explicite
