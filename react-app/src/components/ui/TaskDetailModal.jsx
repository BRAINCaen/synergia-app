...
export const TaskDetailsModal = ({ 
  ...
  // 📋 COMPOSANT SECTION COMMENTAIRES - MÉMORISÉ ET ISOLÉ
  const CommentsSection = useMemo(() => {
    return (
      <div className="p-6 space-y-4">
        ...
        {/* Formulaire d'ajout de commentaire - EN PREMIER POUR PLUS DE VISIBILITÉ */}
        {effectiveUser && (
  ...
  }, [comments, loadingComments, commentText, submittingComment, effectiveUser, handleSubmitComment, handleCommentChange]);
