...
// MODAL DÉTAILS SANS AUCUNE DONNÉE DE DÉMONSTRATION
// ==========================================
...
const TaskDetailModal = ({ 
  ...
  const loadComments = async () => {
    ...
    try {
      ...
      // ✅ AUCUN COMMENTAIRE DE DÉMO - Seulement les vrais commentaires depuis Firebase
      // TODO: Implémenter la récupération réelle des commentaires depuis Firebase
      // const commentsSnapshot = await getDocs(collection(db, 'comments'), where('taskId', '==', task.id));
      // const realComments = commentsSnapshot.docs.map(doc => ({ id: doc.id, ...doc.data() }));
  ...
  const addComment = async () => {
    ...
    try {
      ...
      // TODO: Ajouter le commentaire réel à Firebase
      // const commentData = {
      //   taskId: task.id,
