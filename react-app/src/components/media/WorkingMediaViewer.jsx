// ==========================================
// 📁 react-app/src/components/media/WorkingMediaViewer.jsx
// VIEWER UNIFIÉ QUI FONCTIONNE VRAIMENT AVEC FIREBASE STORAGE
// ==========================================

import React from 'react';
import WorkingVideoPlayer from './WorkingVideoPlayer.jsx';
import WorkingImageViewer from './WorkingImageViewer.jsx';
import { FileImage, Video, AlertTriangle } from 'lucide-react';

/**
 * 🎬🖼️ VIEWER UNIFIÉ QUI FONCTIONNE VRAIMENT
 */
const WorkingMediaViewer = ({ 
  mediaUrl, 
  mediaType = null,
  className = "",
  controls = true,
...
/**
 * 🎬 COMPOSANT SPÉCIALISÉ POUR LES TÂCHES QUI FONCTIONNE
 */
export const WorkingTaskMediaViewer = ({ task, className = "" }) => {
    ...
    <div className={className}>
      ...
      <div className="mt-2 text-xs text-gray-500">
        ...
        <div className="mt-1 text-yellow-600 font-medium">
          💡 Astuce: La vidéo est téléchargée automatiquement pour assurer la lecture
        </div>
      </div>
    </div>
  );
...
export default WorkingMediaViewer;
