...
// Pages en développement avec fallback
const ShopPage = () => <FallbackPage title="Boutique" description="Boutique de récompenses" />;
...
const RoleTasksPage = () => (
  <div className="min-h-screen bg-gray-900 p-6">
    <div className="max-w-4xl mx-auto text-center">
      ...
      <p className="text-gray-400 mb-8">Développez votre expertise dans vos domaines de spécialisation</p>
