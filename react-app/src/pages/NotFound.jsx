...
// SETTINGS PAGE - VERSION MINIMALE
// ==========================================
...
const RewardsPage = () => {
  const rewards = [
    { id: 1, name: 'Badge Expert', cost: 500, type: 'badge', available: true },
    { id: 2, name: 'Avatar Premium', cost: 1000, type: 'cosmetic', available: false },
    { id: 3, name: 'Titre Spécial', cost: 750, type: 'title', available: true },
  ];
    ...
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-6xl mx-auto">
        <div className="bg-white rounded-xl shadow-sm p-6 mb-6">
          ...
          <p className="text-gray-600 mt-1">
            Échangez vos points XP contre des récompenses exclusives
          </p>
        </div>
          ...
          {rewards.map((reward) => (
            <div key={reward.id} className="bg-white rounded-xl shadow-sm p-6">
              <div className="text-center">
                ...
                <p className="text-2xl font-bold text-purple-600 mb-4">{reward.cost} XP</p>
                <button
