...
// PAGE TÂCHES PAR RÔLE - GLASSMORPHISM DESIGN
// ==========================================

import React from 'react';
import { motion } from 'framer-motion';
import { CheckSquare, Target, Star, Construction } from 'lucide-react';
    ...
    <Layout>
      <div className="min-h-screen bg-gradient-to-br from-slate-950 via-purple-950/50 to-slate-950 relative overflow-hidden">
        ...
        <div className="relative z-10 px-3 sm:px-6 py-4 sm:py-6 pb-24 sm:pb-8 max-w-6xl mx-auto">
          ...
          >
            <div className="w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-br from-blue-500/30 to-purple-500/20 rounded-2xl flex items-center justify-center mx-auto mb-4 sm:mb-6">
              <Construction className="w-8 h-8 sm:w-10 sm:h-10 text-blue-400" />
            </div>
            <h2 className="text-lg sm:text-2xl font-bold text-white mb-2 sm:mb-3">En Développement</h2>
            <p className="text-gray-400 text-sm sm:text-base max-w-md mx-auto mb-6">
              Le système de tâches par rôle sera bientôt disponible
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 text-left">
              ...
              >
                <Target className="w-5 h-5 sm:w-6 sm:h-6 text-green-400 mb-2" />
                <h3 className="text-white font-semibold mb-1 text-sm sm:text-base">Tâches Ciblées</h3>
                <p className="text-gray-400 text-xs sm:text-sm">Accédez aux tâches spécifiques à votre rôle</p>
              </motion.div>
              <motion.div
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
              ...
              >
                ...
                <h3 className="text-white font-semibold mb-1 text-sm sm:text-base">Progression</h3>
                <p className="text-gray-400 text-xs sm:text-sm">Suivez votre évolution dans votre domaine</p>
              </motion.div>
              <motion.div
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
                ...
                className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-xl p-4"
              >
                <CheckSquare className="w-5 h-5 sm:w-6 sm:h-6 text-purple-400 mb-2" />
                <h3 className="text-white font-semibold mb-1 text-sm sm:text-base">Validation</h3>
                <p className="text-gray-400 text-xs sm:text-sm">Validez vos compétences acquises</p>
              </motion.div>
            </div>
          </motion.div>
