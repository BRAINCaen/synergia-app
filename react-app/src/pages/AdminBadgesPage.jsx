...
import { Trophy, Users, ArrowLeft, RefreshCw, Plus, Edit, Trash2 } from 'lucide-react';
              ...
              <div>
                {badges.length > 0 ? (
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {badges.map((badge) => (
                      <div key={badge.id} className="bg-white rounded-lg border p-6">
            ...
            {activeTab === 'users' && (
              <div>
                {users.length > 0 ? (
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {users.map((userData) => (
                      <div key={userData.id} className="bg-white rounded-lg border p-6">
